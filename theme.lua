...
local theme  =           {
	...
	MenuBarBg                           =           { 0   , 0   , 0   , 0    },
	ScrollbarBg                         =           { 0.06, 0.04, 0.06, 1    },
	ScrollbarGrab                       =           { 0.95, 0.30, 0.28, 1    },
	ScrollbarGrabHovered                =           { 0.95, 0.30, 0.28, 1    },
	ScrollbarGrabActive                 =           { 0.95, 0.30, 0.28, 1    },
	CheckMark                           =           { 0.95, 0.30, 0.28, 1    },
	...
	Separator                           =           { 0.20, 0.56, 0.59, 1    },
	SeparatorHovered                    =           { 0.20, 0.56, 0.59, 1    },
	SeparatorActive                     =           { 0.20, 0.56, 0.59, 1    },
	ResizeGrip                          =           { 0.06, 0.04, 0.06, 1    },
	ResizeGripHovered                   =           { 0.95, 0.30, 0.28, 1    },
	ResizeGripActive                    =           { 0.95, 0.30, 0.28, 1    },
	Tab                                 =           { 0   , 0   , 0   , 0    },
	TabHovered                          =           { 0   , 0   , 0   , 0    },
	TabActive                           =           { 0   , 0   , 0   , 0    },
	...
	COUNT                               =           { 0   , 0   , 0   , 0    },
	CustomToggleOn                      =           { 0.36, 0.96, 1   , 1    },
	CustomToggleOnHovered               =           { 0.29, 0.77, 0.79, 1    },
