return {
  example = { --Example needs to be changed to language code.
    console_msg_loaded1                    = "************************************************" ,
    console_msg_loaded2                    = " Cyber Engine Tweaks Mod Manager Loaded...      " ,
    ...
    text_help_manager_1                    = "Press [Scan] to scan the Cyber Engine Tweaks mods you have installed." ,
