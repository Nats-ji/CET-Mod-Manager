return {
  pt_br = {
    ...
    console_msg_dofile_run                 = "[CETMM] Executing %{nome do arquivo}." ,
    ...
    text_help_manager_1                    = "Press [Analisar] to scan the CyberEngineTweaks mods you have installed." ,
    text_help_manager_2                    = "Tick/untick the checkbox to enable/disable mods." ,
    text_help_manager_3                    = "Change [Modo Janela] in Game\'s [Configurações] - [Video] to [Janelas sem Bordas] to avoid being thrown out to desktop when pressing [Analisar]." ,
    text_help_manager_4                    = "After Enabling/Disabling mods, press the [Reload ALL Mods] button on console to reload the mods." ,
    text_help_manager_5                    = "Press [Varredura Automática] button to enable auto scan when the mod manager is loaded." ,
    text_help_dofiles_1                    = "You can run your favorite \"dofile()\" lua mods here with a press of button." ,
    text_help_dofiles_2                    = "To use this feature, press the [Pasta de Arquivo] button on the button to open the folder. Copy your *.lua mod that runs with \"dofile()\" in here." ,
    text_help_dofiles_3                    = "Press [Analisar] button to refresh the mod list." ,
    text_help_dofiles_4                    = "After the mod list has been loaded, press the [Executar] button in front of them to run them with a press of button. No moar dofile()!" ,
    ...
    console_msg_mod_enable                 = "[CETMM] %{nome do mod} has been enabled." ,
    console_msg_mod_enable_error           = "[CETMM] Error when trying to enable %{nome do mod}" ,
    console_msg_mod_disable                = "[CETMM] %{nome do mod} has been disabled." ,
    console_msg_mod_disable_error          = "[CETMM] Error when trying to disable %{nome do mod}" ,
    text_select_lang                       = "Selecte a Language (Necessita de suporte de fontes)",
